...
# well logs
well_logs_sp <- read_rds("well_logs_sp.rds") 
...
s <- shapefile("amber_napa/cnty_bndry_simplified_250ft_WGS84.shp") %>% 
...
#st_write(wells_in_s, "napa_wells.shp")
```
...
[DOWNLOAD SHAPEFILE](https://github.com/richpauloo/rp/raw/master/content/wcr/napa/napa_wells.zip)
